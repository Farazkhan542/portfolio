...
export const WhatsApp = (props) => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M17.47 14.38c-.29-.15-1.73-.85-2-.95-.27-.1-.46-.15-.66.15-.2.29-.76.94-.93 1.14-.17.19-.34.22-.63.07-.29-.15-1.22-.45-2.32-1.43-.86-.76-1.44-1.71-1.6-2-.17-.29-.02-.45.13-.6.13-.13.29-.34.44-.51.15-.17.19-.29.29-.48.1-.2.05-.36-.02-.51-.07-.15-.66-1.59-.9-2.18-.24-.57-.48-.5-.66-.51h-.56c-.2 0-.51.07-.78.36-.27.29-1.02 1-1.02 2.43 0 1.43 1.04 2.81 1.19 3 .15.19 2.05 3.13 4.97 4.39.69.3 1.24.48 1.66.61.7.22 1.33.19 1.83.12.56-.08 1.73-.71 1.97-1.39.24-.68.24-1.27.17-1.39-.07-.12-.26-.19-.55-.34z" />
    <path d="M12.04 2C6.55 2 2.09 6.46 2.09 12c0 1.77.46 3.45 1.34 4.94L2 22l5.2-1.37a9.9 9.9 0 0 0 4.84 1.24h.01c5.49 0 9.95-4.46 9.95-10S17.53 2 12.04 2zm5.86 15.78a8.13 8.13 0 0 1-5.86 2.43h-.01a8.2 8.2 0 0 1-4.18-1.15l-.3-.18-3.09.81.83-3-.19-.31A8.1 8.1 0 0 1 3.85 12c0-4.5 3.68-8.15 8.19-8.15 2.19 0 4.24.85 5.79 2.4a8.06 8.06 0 0 1 2.4 5.75c0 4.5-3.68 8.15-8.19 8.15z" />
  </svg>
);
